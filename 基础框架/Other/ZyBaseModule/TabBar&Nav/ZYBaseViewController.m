...
- (void)setLeftBarButtonItemTitle:(NSString *)leftBarButtonItemTitle {
    self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc]initWithTitle:leftBarButtonItemTitle style:UIBarButtonItemStylePlain target:self action:@selector(leftBarButtonItemClick:)];
}
...
- (void)setRightBarButtonItemTitle:(NSString *)rightBarButtonItemTitle {
    ...
    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc]initWithTitle:rightBarButtonItemTitle style:UIBarButtonItemStyleDone target:self action:@selector(rightBarButtonItemClick:)];
}

#pragma mark - 设置右侧按钮的图片
- (void)setRightBarButtonItemImageName:(NSString *)rightBarButtonItemImageName {
    
    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc]initWithImage:[[UIImage imageNamed:rightBarButtonItemImageName] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal] style:UIBarButtonItemStyleDone target:self action:@selector(rightBarButtonItemClick:)];
}
